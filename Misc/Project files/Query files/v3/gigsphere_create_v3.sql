...
--     freelancer_id CHAR(10),
--     project_id CHAR(10),
--     freelancer_name VARCHAR(100),  -- Partially dependent on freelancer_id
...
-- CREATE TABLE freelancers (
--     freelancer_id CHAR(10) PRIMARY KEY,
--     name VARCHAR(100),
...
--     contract_id CHAR(10),
--     freelancer_email VARCHAR(100),  -- Transitive dependency via contract_id
--     ...
-- );
